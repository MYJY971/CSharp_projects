...
namespace ArucoCSharp
{
    public partial class ArucoForm : Form
    {
        ...
        //public  = "";
        public string _path = "C:\\Stage\\Yanis\\Data\\intrinsics.yml";
        ...
        */
        ...
        private void ProcessFrame(object sender, EventArgs e)
        {
            ...
            _nbMarkers =/*(int) Add(5, 5);//*/(int)TestAR(byteImageForARCompute, _imageForARCompute.Width, _imageForARCompute.Height, _path);
